...
@Component({
  selector: 'app-cou-warehouse',
  templateUrl: './cou-warehouse.component.html',
  styleUrls: ['./cou-warehouse.component.scss']
})
export class CouWarehouseComponent implements OnInit {
